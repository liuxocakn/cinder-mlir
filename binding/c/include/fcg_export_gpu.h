#ifndef __FCG_EXPORT_GPU_H__
#define __FCG_EXPORT_GPU_H__
...
static inline struct MemRef fcg_make_gpu_memref(void* data, int64_t rows, int64_t cols) {
    struct MemRef m;
    m.data = data;
    m.aligned = data;
    m.offset = 0;
...
struct MemRef test_gpu_memref_alloc_f32(int64_t x, int64_t y);
void test_gpu_memref_free_f32(
    void* data, void* aligned, int64_t offset,
    int64_t size0, int64_t size1, int64_t stride0, int64_t stride1
);

struct MemRef test_gpu_memref_alloc_f16(int64_t x, int64_t y);
void test_gpu_memref_free_f16(
    void* data, void* aligned, int64_t offset,
    int64_t size0, int64_t size1, int64_t stride0, int64_t stride1
);

void test_gpu_memref_copy_h2d_f32(
    void* src_data, void* src_aligned, int64_t src_offset,
    int64_t src_size0, int64_t src_size1, int64_t src_stride0, int64_t src_stride1,
    void* dst_data, void* dst_aligned, int64_t dst_offset,
    int64_t dst_size0, int64_t dst_size1, int64_t dst_stride0, int64_t dst_stride1
);

void test_gpu_memref_copy_d2h_f32(
    void* src_data, void* src_aligned, int64_t src_offset,
    int64_t src_size0, int64_t src_size1, int64_t src_stride0, int64_t src_stride1,
    void* dst_data, void* dst_aligned, int64_t dst_offset,
    int64_t dst_size0, int64_t dst_size1, int64_t dst_stride0, int64_t dst_stride1
...
void test_gpu_memref_copy_h2d_f16(
    void* src_data, void* src_aligned, int64_t src_offset,
    int64_t src_size0, int64_t src_size1, int64_t src_stride0, int64_t src_stride1,
    void* dst_data, void* dst_aligned, int64_t dst_offset,
    int64_t dst_size0, int64_t dst_size1, int64_t dst_stride0, int64_t dst_stride1
...
void test_gpu_memref_copy_d2h_f16(
    void* src_data, void* src_aligned, int64_t src_offset,
    int64_t src_size0, int64_t src_size1, int64_t src_stride0, int64_t src_stride1,
    void* dst_data, void* dst_aligned, int64_t dst_offset,
    int64_t dst_size0, int64_t dst_size1, int64_t dst_stride0, int64_t dst_stride1
...
static inline struct MemRef fcg_matmul_f32(struct MemRef A, struct MemRef B, struct MemRef out) {
    return test_matmul_f32(
        (float*)A.data, (float*)A.aligned, A.offset,
        A.sizes[0], A.sizes[1], A.strides[0], A.strides[1],
        (float*)B.data, (float*)B.aligned, B.offset,
        B.sizes[0], B.sizes[1], B.strides[0], B.strides[1],
        (float*)out.data, (float*)out.aligned, out.offset,
...
static inline struct MemRef fcg_relu_f32(struct MemRef input, struct MemRef out) {
    return test_relu_f32(
        (float*)input.data, (float*)input.aligned, input.offset,
...
static inline struct MemRef fcg_full_flow_f32(struct MemRef A, struct MemRef B, struct MemRef bias, struct MemRef out) {
    return test_full_flow_f32(
        ...
        (float*)B.data, (float*)B.aligned, B.offset,
        B.sizes[0], B.sizes[1], B.strides[0], B.strides[1],
        (float*)bias.data, (float*)bias.aligned, bias.offset,
...
static inline void fcg_memref_free_f32(struct MemRef memref) {
    test_memref_free_f32(
        memref.data, memref.aligned, memref.offset,
        memref.sizes[0], memref.sizes[1], memref.strides[0], memref.strides[1]
    );
}
...
static inline struct MemRef fcg_gpu_memref_alloc_f32(int64_t x, int64_t y) {
    return test_gpu_memref_alloc_f32(x, y);
}

static inline void fcg_gpu_memref_free_f32(struct MemRef memref) {
    test_gpu_memref_free_f32(
        memref.data, memref.aligned, memref.offset,
        memref.sizes[0], memref.sizes[1], memref.strides[0], memref.strides[1]
    );
}

static inline struct MemRef fcg_gpu_memref_alloc_f16(int64_t x, int64_t y) {
    return test_gpu_memref_alloc_f16(x, y);
}

static inline void fcg_gpu_memref_free_f16(struct MemRef memref) {
    test_gpu_memref_free_f16(
        memref.data, memref.aligned, memref.offset,
        memref.sizes[0], memref.sizes[1], memref.strides[0], memref.strides[1]
    );
}

static inline void fcg_gpu_memref_copy_h2d_f32(struct MemRef src, struct MemRef dst) {
    test_gpu_memref_copy_h2d_f32(
        src.data, src.aligned, src.offset,
        src.sizes[0], src.sizes[1], src.strides[0], src.strides[1],
        dst.data, dst.aligned, dst.offset,
        dst.sizes[0], dst.sizes[1], dst.strides[0], dst.strides[1]
    );
}

static inline void fcg_gpu_memref_copy_d2h_f32(struct MemRef src, struct MemRef dst) {
    test_gpu_memref_copy_d2h_f32(
        src.data, src.aligned, src.offset,
        src.sizes[0], src.sizes[1], src.strides[0], src.strides[1],
        dst.data, dst.aligned, dst.offset,
        dst.sizes[0], dst.sizes[1], dst.strides[0], dst.strides[1]
...
static inline void fcg_gpu_memref_copy_h2d_f16(struct MemRef src, struct MemRef dst) {
    test_gpu_memref_copy_h2d_f16(
        src.data, src.aligned, src.offset,
        src.sizes[0], src.sizes[1], src.strides[0], src.strides[1],
        dst.data, dst.aligned, dst.offset,
        dst.sizes[0], dst.sizes[1], dst.strides[0], dst.strides[1]
...
static inline void fcg_gpu_memref_copy_d2h_f16(struct MemRef src, struct MemRef dst) {
    test_gpu_memref_copy_d2h_f16(
        src.data, src.aligned, src.offset,
        src.sizes[0], src.sizes[1], src.strides[0], src.strides[1],
        dst.data, dst.aligned, dst.offset,
        dst.sizes[0], dst.sizes[1], dst.strides[0], dst.strides[1]
