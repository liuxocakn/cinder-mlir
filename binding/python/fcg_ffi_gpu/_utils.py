...
def fcg_gpu_memref_alloc_f32(x, y):
    return core._lib.test_gpu_memref_alloc_f32(x, y)


def fcg_gpu_memref_free_f32(memref):
    if memref.data:
        core._lib.test_gpu_memref_free_f32(
            memref.data,
            memref.aligned,
            memref.offset,
            memref.sizes[0],
...
def fcg_gpu_memref_alloc_f16(x, y):
    return core._lib.test_gpu_memref_alloc_f16(x, y)


def fcg_gpu_memref_free_f16(memref):
    if memref.data:
        core._lib.test_gpu_memref_free_f16(
            memref.data,
            memref.aligned,
            memref.offset,
            memref.sizes[0],
...
def fcg_gpu_memref_copy_h2d_f32(src, dst):
    core._lib.test_gpu_memref_copy_h2d_f32(
...
def fcg_gpu_memref_copy_d2h_f32(src, dst):
    core._lib.test_gpu_memref_copy_d2h_f32(
        src.data, src.aligned, src.offset,
        src.sizes[0], src.sizes[1], src.strides[0], src.strides[1],
        dst.data, dst.aligned, dst.offset,
        dst.sizes[0], dst.sizes[1], dst.strides[0], dst.strides[1]
...
def fcg_gpu_memref_copy_h2d_f16(src, dst):
    core._lib.test_gpu_memref_copy_h2d_f16(
        src.data, src.aligned, src.offset,
        src.sizes[0], src.sizes[1], src.strides[0], src.strides[1],
        dst.data, dst.aligned, dst.offset,
        dst.sizes[0], dst.sizes[1], dst.strides[0], dst.strides[1]
...
def fcg_gpu_memref_copy_d2h_f16(src, dst):
    core._lib.test_gpu_memref_copy_d2h_f16(
        src.data, src.aligned, src.offset,
        src.sizes[0], src.sizes[1], src.strides[0], src.strides[1],
        dst.data, dst.aligned, dst.offset,
        dst.sizes[0], dst.sizes[1], dst.strides[0], dst.strides[1]
